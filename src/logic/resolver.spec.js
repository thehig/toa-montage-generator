...
describe('resolver', () => {
    ...
    describe('distance/pace', () => {
      ...
      describe('with a boat', () => {
        ...
        it('should have distance 1 when pace is slow and d4 rolls low', () =>
          expect(navcheckD4Low({ navigator, speed: 'boat', pace: 'slow' }).distance).toBe(1));
        it('should have distance 2 when pace is slow and d4 rolls high', () =>
          expect(navcheckD4High({ navigator, speed: 'boat', pace: 'slow' }).distance).toBe(2));

        it('should have distance 2 when pace is fast and d4 rolls low', () =>
          expect(navcheckD4Low({ navigator, speed: 'boat', pace: 'fast' }).distance).toBe(2));
        it('should have distance 3 when pace is fast and d4 rolls high', () =>
          expect(navcheckD4High({ navigator, speed: 'boat', pace: 'fast' }).distance).toBe(3));
      });
    });
  ...
  describe('weather', () => {
    ...
    it('returns "light" for 6 - 10', () =>
      expect(weatherD20([6, 7, 8, 9, 10])().name).toBe('light'));
    it('returns "medium" for 11 - 15', () =>
      expect(weatherD20([11, 12, 13, 14, 15])().name).toBe('medium'));
    it('returns "heavy" for 16 - 19', () =>
      expect(weatherD20([16, 17, 18, 19])().name).toBe('heavy'));
